...
class Mapping(object):
    ...
    def semantic_clustering(self, frame, frame_id, frame_map, sam_masks, rend_clusters, mask_lang_feat, vis_caption="visualization/"):
        ...
        intersection_matrix_b = (assignments[depth_determining][:,visible_clusters_ind].unsqueeze(2) & current_assignments[depth_determining].unsqueeze(1)).sum(dim=0)
        union_matrix_b = (assignments[depth_determining][:,visible_clusters_ind].unsqueeze(2) | current_assignments[depth_determining].unsqueeze(1)).sum(dim=0)
